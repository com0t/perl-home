...
--
-- Table structure for table `vmware_hostphysicalnic`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `vmware_hostphysicalnic` (
  `deviceid` bigint(20) unsigned DEFAULT NULL,
  `device` varchar(255) DEFAULT NULL,
  `driver` varchar(255) DEFAULT NULL,
  `nickey` varchar(255) DEFAULT NULL,
  `speedmb` int(10) unsigned DEFAULT NULL,

...
--
-- Table structure for table `vmware_hostmultipath`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `vmware_hostmultipath` (
  `deviceid` bigint(20) unsigned DEFAULT NULL,
  `id` varchar(255) DEFAULT NULL,
  `multikey` varchar(255) DEFAULT NULL,
  `lun` varchar(255) DEFAULT NULL,
  `adapter` varchar(255) DEFAULT NULL,
  `isworkingpath` varchar(10) DEFAULT NULL,
  `pathkey` varchar(255) DEFAULT NULL,
  `pathlun` varchar(255) DEFAULT NULL,
  `pathname` varchar(255) DEFAULT NULL,
  `pathstate` varchar(20) DEFAULT NULL,

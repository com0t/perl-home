...
--
-- Table structure for table `gensrvserver`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `gensrvserver` (
  `deviceid` bigint(40) DEFAULT NULL,
  `uptime` bigint(40) DEFAULT NULL,
  `processes` int(11) DEFAULT NULL,
  `memorysize` bigint(40) DEFAULT NULL,
  `numberofusers` int(11) DEFAULT NULL,
  `numcpus` int(11) DEFAULT NULL,
  `numcores` int(11) DEFAULT NULL,

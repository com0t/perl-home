...
--
-- Table structure for table `csqdscpmapping`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `csqdscpmapping` (
  `deviceid` bigint(40) DEFAULT NULL,
  `dscp` varchar(50) DEFAULT NULL,
  `cos` int(11) DEFAULT NULL,
  `exp` varchar(50) DEFAULT NULL,
  `normalburstdscp` varchar(50) DEFAULT NULL,
  `maxburstdscp` varchar(50) DEFAULT NULL,

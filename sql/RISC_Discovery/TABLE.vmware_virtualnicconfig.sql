...
--
-- Table structure for table `vmware_virtualnicconfig`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `vmware_virtualnicconfig` (
  `deviceid` bigint(40) DEFAULT NULL,
  `scantime` int(11) DEFAULT NULL,
  `device` varchar(255) DEFAULT NULL,
  `portgroup` varchar(255) DEFAULT NULL,
  `tsoenabled` varchar(10) DEFAULT NULL,
  ...
  `connectioncookie` int(11) DEFAULT NULL,
  `portgroupkey` varchar(255) DEFAULT NULL,
  `portkey` varchar(255) DEFAULT NULL,
  `distributedvirtswitchuuid` varchar(255) DEFAULT NULL,

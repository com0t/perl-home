...
CREATE TABLE IF NOT EXISTS `ntpinfo` (
  ...
  `associd` int(15) DEFAULT NULL,
  `peeraddress` varchar(100) DEFAULT NULL,
  `peerport` int(15) DEFAULT NULL,
  `peermode` varchar(100) DEFAULT NULL,
  `stratum` int(15) DEFAULT NULL,

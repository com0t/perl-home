...
--
-- Table structure for table `vmware_portgroup`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `vmware_portgroup` (
  `deviceid` bigint(40) DEFAULT NULL,
  `scantime` int(11) DEFAULT NULL,
  `pgkey` varchar(255) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
  `vlanid` int(11) DEFAULT NULL,
  `vswitchname` varchar(255) DEFAULT NULL,

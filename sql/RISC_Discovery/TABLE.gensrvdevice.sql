...
--
-- Table structure for table `gensrvdevice`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `gensrvdevice` (
  `deviceid` bigint(40) DEFAULT NULL,
  `devtype` varchar(255) DEFAULT NULL,
  `devdescription` varchar(255) DEFAULT NULL,
  `devid` int(11) DEFAULT NULL,
  `devstatus` varchar(255) DEFAULT NULL,
  `deverrors` varchar(255) DEFAULT NULL,

...
--
-- Table structure for table `winperfexchdatabase`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `winperfexchdatabase` (
  ...
  `databasecachepercentdehydrated` bigint(40) unsigned DEFAULT NULL,
  `databasecachepercenthit` bigint(40) unsigned DEFAULT NULL,
  `databasecacherequestspersec` bigint(40) unsigned DEFAULT NULL,
  `databasecachesize` bigint(40) unsigned DEFAULT NULL,
  `databasecachesizeeffective` bigint(40) unsigned DEFAULT NULL,
  `databasecachesizeeffectivemb` int(10) unsigned DEFAULT NULL,
  `databasecachesizemb` int(10) unsigned DEFAULT NULL,
  `databasecachesizeresident` bigint(40) unsigned DEFAULT NULL,
  `databasecachesizeresidentmb` int(10) unsigned DEFAULT NULL,
  ...
  `databasepageevictionspersec` bigint(40) unsigned DEFAULT NULL,
  `databasepagefaultspersec` bigint(40) unsigned DEFAULT NULL,
  `databasepagefaultstallspersec` bigint(40) unsigned DEFAULT NULL,

...
--
-- Table structure for table `assessmentstatus`
--
...
CREATE TABLE IF NOT EXISTS `assessmentstatus` (
  ...
  `currentvalue` varchar(45) DEFAULT NULL,
  `lastvalue` varchar(45) NOT NULL,
  `currentscantime` int(10) unsigned DEFAULT NULL,
  `lastscantime` int(10) unsigned DEFAULT NULL,
